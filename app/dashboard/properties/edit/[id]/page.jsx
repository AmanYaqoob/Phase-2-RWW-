...
export default function EditPropertyPage() {
  ...
  const steps = [
    ...
    { id: 5, title: "Activities", active: false },
    { id: 6, title: "Images", active: false }
  ]
  ...
  useEffect(() => {
    ...
    if (property) {
      ...
      // Convert image URLs to uploaded images format
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Update the essential details about your retreat property</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  />
                  <p className="text-sm text-gray-500 mt-2">Update the compelling title that captures the essence of your retreat</p>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Update your nightly rate in USD</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                />
                <p className="text-sm text-gray-500 mt-2">Update the vivid picture of your property and the retreat experience</p>
              </div>
            </div>
          </div>
        )
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Update the location information for your retreat</p>
            </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                <div className="space-y-8">
                  <div>
                    ...
                    />
                    <p className="text-sm text-gray-500 mt-2">Update the complete address including city, state, and country</p>
                  </div>

                  <div className="border-t pt-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">GPS Coordinates (Optional)</h3>
                    <p className="text-sm text-gray-600 mb-6">Update exact coordinates for mapping and navigation services</p>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Update the type and capacity of your retreat property</p>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-8 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-2">Update the category that best describes your property</p>
                  </div>
                </div>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Update all amenities available at your retreat property</p>
            </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  <p className="text-sm text-blue-800">
                    💡 <strong>Tip:</strong> Update all amenities that are available to guests.
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Update retreat activities and experiences you offer</p>
            </div>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Update photos of your retreat property</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Update your retreat listing in 6 simple steps</p>
                </div>
              </div>
