...
import { Search, MapPin, Calendar, Users, X, ChevronRight, Sparkles } from "lucide-react"
    ...
    <div ref={searchBarRef} className="w-full max-w-4xl mx-auto relative z-50">
      ...
      {!isExpanded ? (
        <motion.div
          ...
          className="bg-white rounded-full shadow-lg overflow-hidden flex items-center p-2"
        >
          <div
            className="flex-1 p-3 cursor-pointer flex items-center"
            onClick={() => {
              setIsExpanded(true)
          ...
          <Button
            ...
            className="ml-2 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 rounded-full h-14 w-14 p-0 shadow-md"
          >
